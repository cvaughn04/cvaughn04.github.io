...
function ratingImage (rating) {
      let imageText = "";
            if (rating >= 8) {
                  imageText = imageText + '<img src = "Rotten_Tomatoes_4.png" style="width:50px;">';
            } else if ((rating < 8) && (rating >=6)) {
                  imageText = imageText + '<img src = "Rotten_Tomatoes_3.png" style="width:50px;">';
            } else if ((rating < 6) && (rating >=4)) {
                  imageText = imageText + '<img src = "Rotten_Tomatoes_2.png" style="width:50px;">';
            } else {
                  imageText = imageText + '<img src = "Rotten_Tomatoes_1.png" style="width:50px;">';
            }
      return imageText;
}
